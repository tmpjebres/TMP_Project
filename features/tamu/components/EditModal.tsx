...
export default function EditModal({ tamu, onSave, onClose }: EditModalProps) {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col">
        ...
        <div className="space-y-5 overflow-y-auto px-8">
          <div>
        ...
        <div className="flex gap-3 p-8 pt-7 flex-shrink-0">
