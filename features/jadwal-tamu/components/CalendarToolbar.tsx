    ...
    <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
      <div className="flex items-center gap-3">
        <div className="flex items-center rounded-lg overflow-hidden" style={{ border: '1px solid #DDDDDD' }}>
          <button
            onClick={onPrev}
            className="p-2 hover:bg-green-light dark:hover:bg-dark-brand-light text-neutral-gray dark:text-dark-text-secondary hover:text-green-primary dark:hover:text-dark-brand-accent transition-colors"
          ...
          <button
            onClick={onToday}
            className="px-3 py-2 text-sm font-medium text-neutral-gray dark:text-dark-text-secondary hover:text-green-primary dark:hover:text-dark-brand-accent hover:bg-green-light dark:hover:bg-dark-brand-light transition-colors border-x"
      ...
      <div className="flex items-center gap-3">
        ...
        {canAdd && (
          <button
            onClick={onAdd}
            className="flex items-center gap-1.5 px-4 py-2 bg-green-primary dark:bg-dark-brand-secondary text-white text-sm font-semibold rounded-lg hover:bg-green-secondary dark:hover:bg-dark-brand-primary transition-colors"
          >
            <Plus size={16} />
            Tambah Event
          </button>
